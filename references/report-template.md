...
- If GitHub/code is private, only inferred from founder reputation, or not inspected, cap Code at 6 and confidence at Medium. Do not call it `high-quality code`, `active repo`, or `strong code provenance` without a literal repo/org URL and age/history check.
